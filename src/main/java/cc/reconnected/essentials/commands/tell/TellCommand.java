...
public class TellCommand {
    ...
    public static void sendDirectMessage(String targetName, ServerCommandSource source, String message) {
        ...
        if (targetName.equalsIgnoreCase("server")) {
            ...
            if (targetPlayer == null) {
                ...
                source.sendFeedback(() -> Placeholder.parse(
                        RccEssentials.CONFIG.textFormats.commands.tell.playerNotFound,
                        sourceContext,
                        placeholders
                ), false);
                return;
        ...
        var you = Placeholder.parse(RccEssentials.CONFIG.textFormats.commands.tell.you);
        ...
        var sourceText = Placeholder.parse(
                RccEssentials.CONFIG.textFormats.commands.tell.message,
                sourceContext,
        ...
        var spyText = Placeholder.parse(
                RccEssentials.CONFIG.textFormats.commands.tell.messageSpy,
                serverContext,
                placeholders
        );
        ...
        var lp = RccLibrary.getInstance().luckPerms();
